    ...
    <body>
        <div class="page">
            ...
            <div class="card">
                ...
                <h1 class="title font-display">La pagina expiro.</h1>
                <p class="subtitle">
                    Tu sesion o el token de seguridad ya no son validos. Por favor recarga la pagina y vuelve a intentar.
                </p>
                <div class="actions">
                    <button class="btn primary" type="button" id="reload">Recargar</button>
                    <button class="btn" type="button" id="goDemo">Solicitar demo</button>
                </div>
                <p class="muted">Si esto se repite, revisa tu conexion o inicia sesion de nuevo.</p>
            </div>
        </div>
