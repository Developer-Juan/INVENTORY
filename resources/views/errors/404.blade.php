    ...
    <body>
        <div class="page">
            ...
            <div class="card">
                ...
                <h1 class="title font-display">Esta página no existe.</h1>
                <p class="subtitle">
                    La ruta que estás buscando no está disponible o fue movida. Te redirigiremos automáticamente en
                    <strong><span id="countdown">30</span></strong> segundos.
                </p>
                <div class="timer">
                    <span>Regresando a la pantalla anterior...</span>
                </div>
                <div class="actions">
                ...
                <p class="muted">Si crees que esto es un error, contacta a soporte.</p>
            </div>
        </div>
