    ...
    <body>
        <div class="page">
            ...
            <div class="card">
                ...
                <h1 class="title font-display">Ocurrió un fallo en el servidor.</h1>
                <p class="subtitle">
                    Estamos teniendo un inconveniente interno. Intenta recargar en unos minutos.
                </p>
                <div class="actions">
                    <button class="btn primary" type="button" id="reload">Reintentar</button>
                    <button class="btn" type="button" id="goDemo">Solicitar demo</button>
                </div>
                <p class="muted">Si el problema continúa, informa al equipo de soporte.</p>
            </div>
        </div>
